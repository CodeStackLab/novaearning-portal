...
function handleAuth($action, $subaction, $pdo, $body) {
    ...
    if ($action === 'register') {
        ...
        notifyAdmins(
            $pdo,
            'New user registered',
            '<p>A new user registered successfully.</p><p><strong>Name:</strong> ' . htmlspecialchars($name) . '<br><strong>Email:</strong> ' . htmlspecialchars($email) . '<br><strong>User ID:</strong> #' . (int)$newUserId . '</p>',
            'account'
        );
